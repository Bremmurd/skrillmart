    ...
    <div class="w-96">
        ...
        <div class="bg-purple-100 shadow-xl rounded-lg px-8 py-8">
                ...
                <div>
                    ...
                    <input id="email" class="border border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent rounded-md py-2 px-4 w-full shadow-md" type="email" name="email"  required placeholder="Enter Email Address" />
                </div>

                <div class="mt-4">
                    <label for="password" value="{{ __('Password') }}" class="block font-medium text-sm text-gray-700"/>
                    <input id="email" class="border border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent rounded-md py-2 px-4 w-full shadow-md" type="password" name="password" required placeholder="Enter Password" />
                </div>
